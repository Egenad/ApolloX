...
${OBJECTDIR}/Carbon.o: Carbon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Carbon.o Carbon.cpp
...
${OBJECTDIR}/Hierro.o: Hierro.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hierro.o Hierro.cpp
...
${OBJECTDIR}/Magnesio.o: Magnesio.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Magnesio.o Magnesio.cpp
...
${OBJECTDIR}/Titanio.o: Titanio.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Titanio.o Titanio.cpp
