        ...
        if(event.getEventType()== sf::Event::Closed){
           ...
           m2D::RenderWindow::Instance()->close();
            ...
            if(event.getKey() == sf::Keyboard::Return){
                ...
                Nave::Instance()->getMaterials()[0]=20;
                Nave::Instance()->getMaterials()[1]=8;
                Nave::Instance()->getMaterials()[2]=12;
                Nave::Instance()->getMaterials()[3]=13;
...
void Base::reduceLifeBar(){
    if(Nave::Instance()->getShipLife()>0){
        sprites[5].setTextureRect(0,1721,(Nave::Instance()->getShipLife()*221)/1000,8);
    }else{
...
void Base::reparar(){
    ...
    if(Nave::Instance()->getMaterials()[0]>=titanio&&Nave::Instance()->getMaterials()[1]>magnesio&Nave::Instance()->getMaterials()[2]>=hierro&&Nave::Instance()->getMaterials()[3]>=carbon){
        if(Nave::Instance()->getShipLife()!=1000){
